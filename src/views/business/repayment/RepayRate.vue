      ...
      <div class="ant-pro-grid-content">
        <div class="ant-page-header">
          <a-breadcrumb>
            ...
            <a-breadcrumb-item>额度使用率配置</a-breadcrumb-item>
          </a-breadcrumb>
          <div class="ant-page-header-heading">
            <span class="ant-page-header-heading-title">{{name+'_'+'额度使用率配置'}}</span>
          </div>
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    newPlan(status) {
      ...
      const newConfig = {
        attributes: [
          {
            attrKey: "QUOTA_RATE_MIX",
            attrValue: "0"
          },
          {
            attrKey: "QUOTA_RATE_MAX",
            attrValue: "0"
          },
          {
            attrKey: "PRO_PROPOSAL_CONTENT",
            attrValue: "请编辑"
          }
        ],
        bankId: this.$route.params.id,
