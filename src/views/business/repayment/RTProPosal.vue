      ...
      <div class="ant-pro-grid-content">
        <div class="ant-page-header">
          <a-breadcrumb>
            ...
            <a-breadcrumb-item>还款笔数建议配置</a-breadcrumb-item>
          </a-breadcrumb>
          <div class="ant-page-header-heading">
            <span class="ant-page-header-heading-title">{{name+'_'+'还款笔数建议配置'}}</span>
          </div>
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    newPlan(status) {
      ...
      const newConfig = {
        attributes: [
          {
            attrKey: "REPAYMENT_TIMES_MIX",
            attrValue: "0"
          },
          {
            attrKey: "REPAYMENT_TIMES_MAX",
            attrValue: "0"
          },
          {
            attrKey: "NOMAL_REPAYMENT_TIMES_PROPOSAL",
            attrValue: "请编辑"
          },
        ],
        bankId: this.$route.params.id,
