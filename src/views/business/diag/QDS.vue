      ...
      <div class="ant-pro-grid-content">
        <div class="ant-page-header">
          <a-breadcrumb>
            ...
            <a-breadcrumb-item>{{'额度诊断得分'}}</a-breadcrumb-item>
          </a-breadcrumb>
          <div class="ant-page-header-heading">
            <span class="ant-page-header-heading-title">{{name+'_'+'额度诊断得分'}}</span>
          </div>
        </div>
      </div>
    </div>
          ...
          <template slot="attributes" slot-scope="text, record">
            <div>
              ...
              <template v-else>
                ...
                />
                <span style="margin:5px">{{'次'}}</span>
              </template>
            </div>
          </template>
          <template slot="attributest" slot-scope="text, record">
            <div>
              <span style="margin:0 5px">{{"额度诊断得分是"}}</span>
              <a-input
                style="width:50px"
                :defaultValue="text"
