      ...
      <div class="ant-pro-grid-content">
        <div class="ant-page-header">
          <a-breadcrumb>
            ...
            <a-breadcrumb-item>预计提额日期</a-breadcrumb-item>
          </a-breadcrumb>
          <div class="ant-page-header-heading">
            <span class="ant-page-header-heading-title">{{name+'_'+'预计提额日期'}}</span>
          </div>
        </div>
      </div>
    </div>
        ...
        >
          <template slot="attributes" slot-scope="text, record">
            <div>
              ...
              <template v-else>
                <span style="margin:0 5px">{{"提额"}}</span>
                <a-input
                  style="width:50px"
                  :defaultValue="text"
