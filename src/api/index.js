...
const creditCardPage = get('/card/page') // 信用卡管理-分页条件查询列表
const deleteCreditCard = get('/card/deleteById') // 信用卡管理-分页条件查询列表-删除
...
const creditCRPage = post('/proPlan/consumOrRepaymentPage', headers) // 信用卡管理-信用卡提额计划管理-获取单卡提额计划列表
...
const userDiagPage = get('/record/page') // 会员-增值评分列表

const goodsInfo = post('/goods/page', headers) // 商品管理-获取所有商品
const updateGoods = put('/goods/update', headers) // 商品管理-修改商品属性
const addGoods = post('/goods/add', headers) // 商品管理-添加商品
const deleteGoods = post('/goods/delete') // 商品管理-删除商品
