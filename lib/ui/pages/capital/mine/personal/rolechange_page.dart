...
class CRoleChangePage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => CRoleChangePageState();
}

class CRoleChangePageState extends State<CRoleChangePage> {
  @override
  Widget build(BuildContext context) {
    print(AppInstance.currentUser.privilegeList);
