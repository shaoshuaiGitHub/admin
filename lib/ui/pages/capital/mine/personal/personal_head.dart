...
class CapitalPersonalHead extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _CapitalPersonalHead();
}

class _CapitalPersonalHead extends State<CapitalPersonalHead> {
  File headImg;
                                ...
                                DialogButton(
                                  ...
                                  onPressed: () {
                                    if (nameCtl.text.length > 0) {
                                      ...
                                      applocationBloc.personalBackType = 1;
                                      setState(() {});
                                    }
                                  },
                                  width: 120,
