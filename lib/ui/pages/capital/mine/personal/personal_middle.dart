...
import 'rolechange_page.dart';
// import 'changepwd_page.dart';
// import '../../../../../ui/pages/login/idauth_page.dart';
import '../../../../../ui/pages/page_index.dart';

class CapitalPersonalMiddle extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _CapitalPersonalMiddle();
}

class _CapitalPersonalMiddle extends State<CapitalPersonalMiddle> {
    ...
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<UserInfoModel> snapshot) {
        ...
        if (valueLists.length == 0 || isChange) {
          ...
          valueLists.add('${userInfoModel.workAge}天');
                      ...
                      children: <Widget>[
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Image.asset(
                                'assets/images/capital/${iconItems[index]}',
                                width: 17,
                                height: 17),
                            SizedBox(
                              width: 10,
                            ...
                            (index != 3 &&
                                ...
                                ? (index != 8 && index != 9)
                                    ? Image.asset(
                                        'assets/images/capital/arrow_sdown.png',
                                        width: 6,
                                        height: 3)
                                    : Column(
                                        mainAxisAlignment:
                                        ...
                                        children: <Widget>[
                                          ...
                                          Image.asset(
                                              'assets/images/capital/arrow_right.png',
                                              width: 7,
                                              height: 13)
                                        ],
                                      )
