...
class MyInformationMiddle extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _MyInformationMiddle();
}

class _MyInformationMiddle extends State<MyInformationMiddle> {
                      ...
                      children: <Widget>[
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Image.asset(
                                'assets/images/manager/${iconItems[index]}',
                                width: 17,
                                height: 17),
                            SizedBox(
                              width: 10,
